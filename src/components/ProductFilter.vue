        ...
        <form @submit.prevent="submit()" class="filter__form form" action="#" method="get">
          ...
          <fieldset class="form__block">
            ...
            <label class="form__label form__label--select">
              <select v-model.number="currentCategory" class="form__select"
            ...
            <ul class="colors">
              ...
              <li class="colors__item">
                <label class="colors__label">
                  ...
                  value="#FFBE15" v-model="currentColor">
              ...
              <li class="colors__item">
                <label class="colors__label">
                  <input class="colors__radio sr-only" type="radio" name="color"
                  value="#939393" v-model="currentColor">
              ...
              <li class="colors__item">
                <label class="colors__label">
                  <input class="colors__radio sr-only" type="radio" name="color"
                  value="#8BE000" v-model="currentColor">
              ...
              <li class="colors__item">
                <label class="colors__label">
                  <input class="colors__radio sr-only" type="radio" name="color"
                  value="#FF6B00" v-model="currentColor">
              ...
              <li class="colors__item">
                <label class="colors__label">
                  <input class="colors__radio sr-only" type="radio" name="color"
                  value="#FFF" v-model="currentColor">
              ...
              <li class="colors__item">
                <label class="colors__label">
                  <input class="colors__radio sr-only" type="radio" name="color"
                  value="#222" v-model="currentColor">
          ...
          <button @click.prevent="reset()" class="filter__reset button button--second"
          type="button">
            Сбросить
          </button>
        </form>
